...
@section('content')
    <style>
        ...
        .sh-auth-hero::before {
            ...
            inset: 0;
            background: 
                radial-gradient(circle at 20% 30%, rgba(255, 64, 129, 0.15) 0%, transparent 40%),
                radial-gradient(circle at 80% 70%, rgba(255, 128, 171, 0.1) 0%, transparent 40%);
            z-index: 1;
        }
        ...
        <div class="sh-auth-split">
            ...
            <div class="sh-auth-hero">
                ...
                <div class="sh-auth-hero-content">
                    <h1 class="sh-auth-hero-title">{{ __('auth_pages.register.fan_title') }} </h1>
                    <p class="sh-auth-hero-subtitle">
                        {{ __('auth_pages.register.fan_subtitle') }}
                    </p>
                    <ul class="sh-auth-features">
                        <li class="sh-auth-feature-item">
                            <div class="sh-auth-feature-icon"><i class="fas fa-heart"></i></div>
                            {{ __('auth_pages.register.feature_follow') }}
                        </li>
                        <li class="sh-auth-feature-item">
                            <div class="sh-auth-feature-icon"><i class="fas fa-star"></i></div>
                            {{ __('auth_pages.register.feature_vip') }}
                        </li>
                        <li class="sh-auth-feature-item">
                            <div class="sh-auth-feature-icon"><i class="fas fa-coins"></i></div>
                            {{ __('auth_pages.register.feature_tokens') }}
                        </li>
                        <li class="sh-auth-feature-item">
                            <div class="sh-auth-feature-icon"><i class="fas fa-user-shield"></i></div>
                            {{ __('auth_pages.register.feature_privacy') }}
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="sh-auth-form-side">
                <div class="sh-auth-form-container">
                    <div class="sh-auth-header">
                        <h2>{{ __('auth_pages.register.header_title') }}</h2>
                        <p>{{ __('auth_pages.register.header_subtitle') }}</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <button type="submit" class="sh-auth-btn">
                            {{ __('auth_pages.register.btn_register') }}
                        ...
                        <div class="sh-auth-footer">
                            ...
                            <div style="margin-top: 20px; opacity: 0.6; font-size: 0.8rem; color: #fff;">
                                {{ __('auth_pages.register.is_model') }} <a href="{{ route('register.model') }}"
                                    style="color: #D4AF37; text-decoration: none;">{{ __('auth_pages.register.register_here') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
