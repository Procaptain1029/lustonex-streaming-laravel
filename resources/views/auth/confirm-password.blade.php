        ...
        <div class="sh-auth-split">
            ...
            <div class="sh-auth-hero">
                ...
                <div class="sh-auth-hero-content">
                    <h1 class="sh-auth-hero-title">{{ __('auth_pages.confirm_password.title') }}</h1>
                    <p class="sh-auth-hero-subtitle">
                        {{ __('auth_pages.confirm_password.subtitle') }}
                    </p>
                </div>
            </div>
            ...
            <div class="sh-auth-form-side">
                <div class="sh-auth-form-container">
                    <div class="sh-auth-header">
                        <h2>{{ __('auth_pages.confirm_password.title') }}</h2>
                        <p>{{ __('auth_pages.confirm_password.subtitle') }}</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.confirm') }}">
                        ...
                        <div class="sh-auth-group">
                            <label class="sh-auth-label" for="password">{{ __('auth_pages.login.password_label') }}</label>
                            <div class="sh-auth-input-wrapper">
                                <i class="fas fa-lock"></i>
                                <input id="password" class="sh-auth-input" type="password" name="password" required
                                    autocomplete="current-password" placeholder="{{ __('auth_pages.register.confirm_password_placeholder') }}">
                            </div>
                            @error('password')
                        ...
                        <button type="submit" class="sh-auth-btn">
                            {{ __('auth_pages.confirm_password.btn_confirm') }}
