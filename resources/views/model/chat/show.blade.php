...
@section('title', __('model.chat.show.title', ['name' => $otherUser->name]))
...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .message-wrapper { max-width: 90%; gap: 1rem; }
        ...
        .input-box { gap: 8px; padding: 4px 10px; border-radius: 20px; }
    ...
    @media (max-width: 480px) {
        ...
        .chat-input-area {
            padding: 8px;
            padding-bottom: calc(env(safe-area-inset-bottom, 8px) + 5px);
        }
    ...
    <div class="chat-card">
        ...
        <div class="chat-header">
            <div style="display: flex; align-items: center; gap: 1.5rem;">
                <a href="{{ route('model.chat.index') }}" class="action-btn" title="{{ __('chat.show.back') }}">
            ...
            @forelse($messages as $message)
                ...
                @if($lastDate !== $msgDate)
                    <div class="date-separator">
                        <span>{{ $message->created_at->isToday() ? __('model.chat.show.dates.today') : ($message->created_at->isYesterday() ? __('model.chat.show.dates.yesterday') : $message->created_at->format('d M, Y')) }}</span>
                    </div>
            ...
            <form id="message-form" class="input-box">
                ...
                @if(auth()->user()->isModel())
                    <div style="display: flex; gap: 8px;">
                        ...
                        <button type="button" class="attach-btn" title="{{ __('chat.show.input.attach') }}" onclick="document.getElementById('image-upload').click()">
                            <i class="fas fa-paperclip"></i>
                        </button>
                        <button type="button" class="attach-btn" title="{{ __('chat.show.input.camera') }}" onclick="document.getElementById('image-upload').click()">
    ...
    if (imageUpload) {
        imageUpload.addEventListener('change', function() {
            if (this.files && this.files[0]) {
                ...
                fetch(`/model/chat/${conversationId}/message`, {
                    method: 'POST',
                    body: formData
                })
