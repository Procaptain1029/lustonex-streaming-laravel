...
@section('title', __('chat.index.title'))
...
<style>
    ...
    @media (max-width: 768px) {
        .chat-container { padding: 1.5rem 1rem; }
        .premium-header { 
            flex-direction: column; 
        ...
        .avatar-section { margin-right: 1rem; }
        .avatar-frame { width: 48px; height: 48px; border-radius: 12px; }
        .model-name { font-size: 1rem; }
        .preview-text { font-size: 0.85rem; }
        .card-end { margin-left: 1rem; }
    }

    @media (max-width: 480px) {
        .chat-container { padding: 1rem 0.5rem; }
        .premium-header {
            padding: 1rem;
            border-radius: 16px;
        }
        ...
        .chat-controls { margin-bottom: 1rem; }
        .search-box { padding: 8px 12px; }
        .search-box input { font-size: 0.85rem; }
        
        .conversations-list { gap: 0.5rem; }
        .conversation-card {
            padding: 0.75rem;
            border-radius: 12px;
        }
        
        .avatar-section { margin-right: 0.75rem; }
        .avatar-frame { width: 40px; height: 40px; border-radius: 10px; }
        
        .status-dot { width: 10px; height: 10px; border-width: 2px; }
        
        .model-name { font-size: 0.95rem; }
        .preview-text { font-size: 0.8rem; }
        ...
        .time-badge { font-size: 0.65rem; }
        .unread-bubble { width: 18px; height: 18px; font-size: 0.65rem; }
        .expiration-tag { font-size: 0.55rem; padding: 1px 4px; }
        
        .empty-container { padding: 3rem 1rem; }
        .empty-container h3 { font-size: 1.4rem; }
    }
</style>
...
<div class="chat-container">
    <div class="premium-header">
        ...
        <div class="header-actions">
            <!-- Espacio para notificaciones o settings si se requiere -->
        </div>
    </div>
    ...
    @if($conversations->count() > 0)
        <div class="conversations-list">
            @foreach($conversations as $conv)
                ...
                @endphp
                <a href="{{ route('fan.chat.show', $conv['id']) }}" class="conversation-card {{ $isUnread ? 'unread' : '' }}">
