...
@section('title', __('admin.gamification.badges.create.title'))
...
@section('content')
    <div class="page-header">
        <h1 class="page-title">{{ __('admin.gamification-2.badges.create.title') }}</h1>
        <p class="page-subtitle">{{ __('admin.gamification-2.badges.create.subtitle') }}</p>
    </div>


    <div class="sh-page-container">
        <div class="sh-form-card">
            <form action="{{ route('admin.gamification.badges.store') }}" method="POST">
                @csrf
                ...
                <div class="sh-badge-preview-container">
                    ...
                    <div id="preview-name" class="sh-name-preview">{{ __('admin.gamification-2.badges.form.preview_name') }}</div>
                </div>
                ...
                <div class="sh-form-grid">
                    <div class="sh-form-group">
                        ...
                        <input type="text" name="name" class="sh-input" placeholder="{{ __('admin.gamification-2.badges.form.name_placeholder') }}" required
                            onkeyup="updatePreview(this.value, 'name')">
                    </div>
                    <div class="sh-form-group">
                        <label class="sh-label">{{ __('admin.gamification-2.badges.form.icon') }}</label>
                        <input type="text" name="icon" class="sh-input" placeholder="{{ __('admin.gamification-2.badges.form.icon_placeholder') }}" value="fa-award" required
                ...
                <div class="sh-form-grid">
                    <div class="sh-form-group">
                        ...
                        <input type="color" name="color" class="sh-input sh-color-input" value="#d4af37"
                    ...
                    <div class="sh-form-group">
                        ...
                        <select name="type" class="sh-select" required>
                            <option value="milestone">{{ __('admin.gamification-2.badges.form.categories.milestone') }}</option>
                            <option value="hall_of_fame">{{ __('admin.gamification-2.badges.form.categories.hall_of_fame') }}</option>
                            <option value="event">{{ __('admin.gamification-2.badges.form.categories.event') }}</option>
                            <option value="special">{{ __('admin.gamification-2.badges.form.categories.special') }}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="sh-form-group">
                    ...
                    <textarea name="description" class="sh-textarea" placeholder="{{ __('admin.gamification-2.badges.form.description_placeholder') }}"
                        required></textarea>
                </div>
                ...
                <div class="sh-form-group">
                    ...
                    <div class="sh-req-container" id="req-container">
                        <div class="sh-req-row">
                            <input type="text" name="req_key[]" class="sh-input" placeholder="{{ __('admin.gamification-2.badges.form.req_key') }}">
                            <input type="text" name="req_val[]" class="sh-input" placeholder="{{ __('admin.gamification-2.badges.form.req_val') }}">
                ...
                <div class="sh-form-group">
                    <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                        ...
                        <span style="color: #fff; font-weight: 600;">{{ __('admin.gamification-2.badges.form.active_now') }}</span>
                    </label>
                </div>

                <div class="sh-form-actions">
                    <a href="{{ route('admin.gamification.badges.index') }}" class="sh-btn-cancel">{{ __('admin.gamification-2.badges.form.cancel') }}</a>
                    <button type="submit" class="sh-btn-save">{{ __('admin.gamification-2.badges.form.submit_create') }}</button>
                </div>
            </form>
        </div>
    </div>
