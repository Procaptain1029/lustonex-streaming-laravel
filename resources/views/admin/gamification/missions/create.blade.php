...
@section('title', __('admin.gamification.missions.create.title'))
...
@section('breadcrumb')
    ...
    <span class="breadcrumb-separator"><i class="fas fa-chevron-right"></i></span>
    <span class="breadcrumb-item active">{{ __('admin.gamification-2.missions.index.table.actions') }}</span>
@endsection
...
@section('styles')
    <style>
        ...
        /* Old container reset if needed, or reused */
        .sh-form-container {
            /* Removed max-width restriction for grid usage */
            /* max-width: 800px; */
        }
...
@section('content')
    <div class="page-header">
        <h1 class="page-title">{{ __('admin.gamification-2.missions.create.title') }}</h1>
        <p class="page-subtitle">{{ __('admin.gamification-2.missions.create.subtitle') }}</p>
    </div>
    ...
    <div class="sh-page-grid">
        ...
        <div class="sh-form-column">
            <div class="sh-form-card">
                <form action="{{ route('admin.gamification.missions.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="sh-form-section">
                        ...
                        <div class="sh-form-group">
                            ...
                            <input type="text" name="name" class="sh-input" value="{{ old('name') }}"
                                placeholder="{{ __('admin.gamification-2.missions.form.name_placeholder') }}" required>
                        </div>
                        ...
                        <div class="sh-form-group">
                            ...
                            <textarea name="description" class="sh-textarea" rows="3"
                                placeholder="{{ __('admin.gamification-2.missions.form.description_placeholder') }}">{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div class="sh-reward-grid">
                            <div class="sh-form-group">
                                ...
                                <select name="type" class="sh-select" required>
                                    <option value="WEEKLY" {{ old('type') == 'WEEKLY' ? 'selected' : '' }}>{{ __('admin.gamification-2.missions.form.types.weekly') }}
                                    </option>
                                    <option value="LEVEL_UP" {{ old('type') == 'LEVEL_UP' ? 'selected' : '' }}>{{ __('admin.gamification-2.missions.form.types.level_up') }}</option>
                                    <option value="PARALLEL" {{ old('type') == 'PARALLEL' ? 'selected' : '' }}>{{ __('admin.gamification-2.missions.form.types.parallel') }}</option>
                                </select>
                            </div>
                            ...
                            <div class="sh-form-group">
                                ...
                                <select name="role" class="sh-select" required>
                                    <option value="both" {{ old('role') == 'both' ? 'selected' : '' }}>{{ __('admin.gamification-2.missions.form.roles.both') }}
                                    </option>
                                    <option value="fan" {{ old('role') == 'fan' ? 'selected' : '' }}>{{ __('admin.gamification-2.missions.form.roles.fan') }}</option>
                                    <option value="model" {{ old('role') == 'model' ? 'selected' : '' }}>{{ __('admin.gamification-2.missions.form.roles.model') }}</option>
                                </select>
                            </div>
                    ...
                    <div class="sh-form-section">
                        ...
                        <div class="sh-reward-grid">
                            <div class="sh-form-group">
                                ...
                                <input type="text" name="target_action" class="sh-input" value="{{ old('target_action') }}"
                                    placeholder="{{ __('admin.gamification-2.missions.form.target_action_placeholder') }}" required>
                                <small
                            ...
                            <div class="sh-form-group">
                                ...
                                <input type="number" name="goal_amount" class="sh-input" value="{{ old('goal_amount', 1) }}"
                                    min="1" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="sh-reward-grid">
                            <div class="sh-form-group">
                                ...
                                <div style="position: relative;">
                                    <input type="number" name="reward_xp" class="sh-input" value="{{ old('reward_xp', 0) }}"
                            ...
                            <div class="sh-form-group">
                                ...
                                <div style="position: relative;">
                                    <input type="number" name="reward_tickets" class="sh-input"
                                        value="{{ old('reward_tickets', 0) }}" min="0" style="padding-left: 45px;" required>
                    ...
                    <div class="sh-form-actions">
                        <a href="{{ route('admin.gamification.missions.index') }}"
                            class="sh-btn sh-btn-cancel">{{ __('admin.gamification-2.missions.form.cancel') }}</a>
                        <button type="submit" class="sh-btn sh-btn-save">
                            <i class="fas fa-save"></i> {{ __('admin.gamification-2.missions.form.submit_create') }}
                        </button>
                    </div>
                </form>
            </div>
